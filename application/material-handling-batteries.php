...
$query_Application = "SELECT * FROM application where App_Cat='MH'";
...
//connect application
mysqli_select_db($connection, $database_connection);
$query_App_Detail = "SELECT * FROM app_detail where ID='MH'";
...
<!-- MAX: 55 characters -->
<title>Batteries for Material Handling</title>
</head>
...
<div class="container-site">
	...
	<div class="container-fluid container-splash">
		<div class="splash-main">
			<img class="img-responsive splash" src="../graphics/slide-material-handling.png" alt="Fullriver Battery Deep-Cycle AGM Batteries" title="Fullriver Battery Deep-Cycle AGM Batteries" border="0" width="1080" height="475">
		</div>
	</div>
...
<div class="container container-breadcrumbs">
	<div class="col-md-12">
		<ol class="breadcrumb">
			...
			<li>Applications</li>
			<li class="active">Material Handling</li>
		</ol>
	</div>
</div>
...
<div class="container container-content">
	<div class="col-md-9 col-small-7">
		<h1 class="main-header">Material Handling</h1>
		<div role="tabpanel">
			<!-- Nav tabs -->
