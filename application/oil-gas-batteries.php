...
$query_Application = "SELECT * FROM application where App_Cat='OG'";
...
//connect application
mysqli_select_db($connection, $database_connection);
$query_App_Detail = "SELECT * FROM app_detail where ID='OG'";
...
<!-- MAX: 55 characters -->
<title>Batteries for Oil & Gas</title>
</head>
...
<div class="container-site">
	...
	<div class="container-fluid container-splash">
		<div class="splash-main">
			<img class="img-responsive splash" src="../graphics/slide-oil-gas.png" alt="Fullriver Battery Deep-Cycle AGM Batteries" title="Fullriver Battery Deep-Cycle AGM Batteries" border="0" width="1080" height="475">
		</div>
	</div>
	<!-- ROW 3: Search Bar -->
...
<div class="container container-content">
	<div class="col-md-9 col-small-7">
		<h1 class="main-header">Oil &amp; Gas</h1>
		<div role="tabpanel">
			<!-- Nav tabs -->
