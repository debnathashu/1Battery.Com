...
$query_Application = "SELECT * FROM application where App_Cat='CT'";
...
//connect application
mysqli_select_db($connection, $database_connection);
$query_App_Detail = "SELECT * FROM app_detail where ID='CT'";
...
<!-- MAX: 55 characters -->
<title>Batteries for Commercial Trucking</title>
</head>
...
<div class="container-site">
	...
	<div class="container-fluid container-splash">
		<div class="splash-main">
			<img class="img-responsive splash" src="../graphics/slide-commercial-trucking.png" alt="Fullriver Battery Deep-Cycle AGM Batteries" title="Fullriver Battery Deep-Cycle AGM Batteries" border="0" width="1080" height="475">
		</div>
	</div>
...
<div class="container container-breadcrumbs">
	<div class="col-md-12">
		<ol class="breadcrumb">
			...
			<li>Applications</li>
			<li class="active">Commercial Trucking</li>
		</ol>
	</div>
</div>
...
<div class="container container-content">
	<div class="col-md-9 col-small-7">
		<h1 class="main-header">Commercial Trucking</h1>
		<div role="tabpanel">
			<!-- Nav tabs -->
