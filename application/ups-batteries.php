...
$query_Application = "SELECT * FROM application where App_Cat='UPS'";
...
//connect application
mysqli_select_db($connection, $database_connection);
$query_App_Detail = "SELECT * FROM app_detail where ID='UPS'";
...
<div class="container-site">
	...
	<div class="container-fluid container-splash">
		<div class="splash-main">
			<img class="img-responsive splash" src="../graphics/slide-ups.png" alt="Fullriver Battery Deep-Cycle AGM Batteries" title="Fullriver Battery Deep-Cycle AGM Batteries" border="0" width="1080" height="475">
		</div>
	</div>
	<!-- ROW 3: Search Bar -->
