	...
	<div class="panel panel-default">
		<div class="panel-heading" role="tab" id="headingThree">
			<h4 class="panel-title">
				...
				Batteries by Application</a>
			</h4>
		</div>
		<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
			<div class="menu-body">
				<ul class="accordian-menu-products">
					<li><a href="aerial-work-platforms-batteries.php#view-models"> Aerial Work Platforms</a></li>
					<li><a href="commercial-trucking-batteries.php#view-models"> Commercial Trucking</a></li>
					<li><a href="floor-care-batteries.php#view-models"> Floor Cleaning Equipment</a></li>
					<li><a href="golf-batteries.php#view-models"> Golf / Electric Vehicle</a></li>
					<li><a href="marine-batteries.php#view-models"> Marine</a></li>
					<li><a href="material-handling-batteries.php#view-models"> Material Handling</a></li>
					<li><a href="oil-gas-batteries.php#view-models"> Oil &amp; Gas</a></li>
					<li><a href="rv-batteries.php#view-models"> Recreational Vehicles</a></li>
					<li><a href="solar-batteries.php#view-models"> Solar / Renewable Energy</a></li>
					<li><a href="ups-batteries.php#view-models"> UPS</a></li>
				</ul>
			</div>
		</div>
	</div>
