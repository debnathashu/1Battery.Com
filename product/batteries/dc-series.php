...
<div class="container container-breadcrumbs">
	<div class="col-md-12">
		<ol class="breadcrumb">
			...
			<li><a href="../../series/batteries/dc-series.php">DC Series Batteries</a></li>
	...
	<div class="col-md-9 col-small-7">
		...
		<div role="tabpanel">
			...
			<div class="tab-content">
				<?php include'specifications-dc.php'; ?>	
				<?php include'graph&gallery-dc.php'; ?>	
				<?php include'download-dc.php'; ?>	
