...
<div class="container container-breadcrumbs">
	<div class="col-md-12">
		<ol class="breadcrumb">
			...
			<li><a href="../../series/batteries/hc-series.php">HC Series Batteries</a></li>
	...
	<div class="col-md-9 col-small-7">
		...
		<div role="tabpanel">
			...
			<div class="tab-content">
				<?php include'specifications-hc.php'; ?>	
				<?php include'graph&gallery-hc.php'; ?>	
				<?php include'download-hc.php'; ?>	
