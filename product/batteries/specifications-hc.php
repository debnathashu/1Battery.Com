					...
					<div class="table-responsive">
						<table class="table table-condensed spec-table">
							...
							<tbody>
								...
								<tr>
									<td><?php echo $row_bdistab['8Time']; ?> hr</td>
									<td><?php echo $row_bdistab['8Amps']; ?></td>
									<td><?php echo $row_bdistab['8Rate']; ?> CA</td>
								</tr>
								<tr>
									<td><?php echo $row_bdistab['9Time']; ?> hr</td>
									<td><?php echo $row_bdistab['9Amps']; ?></td>
									<td><?php echo $row_bdistab['9Rate']; ?> CA</td>
								</tr>
							</tbody>
						</table>
					</div>
