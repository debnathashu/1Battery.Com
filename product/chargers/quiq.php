...
<!-- MAX: 55 characters -->
<title>Delta-Q <?php echo $row_quiq_all['Name']; ?> Product Information</title>
</head>
		...
		<div class="splash-main splash">
			<div class="splash-product">
				<div class="col-md-5 col-small-5" id="splash-left">
					<span class="splash-header"><?php echo $row_quiq_all['Name']; ?></span><br />
					<span class="splash-text">
						<ul>
							<li><?php echo $row_quiq_all['Usages']; ?></li>
							<li><?php echo $row_quiq_all['ACIC']; ?></li>
							<li><?php echo $row_quiq_all['DCOC']; ?></li>
						</ul>
					</span>
				</div>
				<div class="col-md-7 col-small-5" id="splash-right">
					<img class="img-responsive splash" src="../../graphics/product/charger/quiq/feature/<?php echo $row_quiq_all['FeatureImage']; ?>" alt="<?php echo $row_quiq_all['Name']; ?>" title="<?php echo $row_quiq_all['Name']; ?>" border="0">
				</div>
			</div>
		</div>
	</div>
...
<div class="container container-breadcrumbs">
	<div class="col-md-12">
		<ol class="breadcrumb">
			...
			<li><a href="../../series/chargers/delta-q-quiq-battery-chargers.php">Delta-Q QuiQ</a></li>
			<li class="active"><?php echo $row_quiq_all['Name']; ?> Product Information</li>
		</ol>
	</div>
</div>
...
<div class="container container-content">
	<div class="col-md-9 col-small-7">
		<h1 class="main-header"><?php echo $row_quiq_all['Name']; ?> <?php echo $row_quiq_all['Title']; ?></h1>
		<div role="tabpanel">
			<!-- Nav tabs -->
			...
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane fade in active" id="specifications">
					<div class="row">
						<?php include'specification-quiq.php'; ?>
					</div>
				</div>
	
				<div role="tabpanel" class="tab-pane fade" id="gallery">
					<?php include'gallery-quiq.php'; ?>
				</div>
				<div role="tabpanel" class="tab-pane fade" id="downloads">
					<?php include'download-quiq.php'; ?>
				</div>

				<div role="tabpanel" class="tab-pane fade" id="accessories">
					<?php include'accessories-quiq.php'; ?>
				</div>		
			</div>
		</div>
	</div>
