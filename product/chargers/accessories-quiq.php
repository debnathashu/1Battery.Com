			...
			<?php do { ?>
				<tr>
					<td style="vertical-align: middle;">
						<a href="../../graphics/product/charger/quiq/acco/<?php echo $row_C_Accessories['Image']; ?>" rel="shadowbox"><img class="responsive spec-table-img" src="../../graphics/product/charger/quiq/acco/<?php echo $row_C_Accessories['Image']; ?>"></a>
					</td>
