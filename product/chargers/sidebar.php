<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
		...
		<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
			<div class="menu-body">
				<ul class="accordian-menu-products">
					<li><a href="../../series/batteries/dc-series.php#view-models"> DC Series</a></li>
					<li><a href="../../series/batteries/full-force.php#view-models"> Full Force</a></li>
					<li><a href="../../series/batteries/hc-series.php#view-models"> HC Series</a></li>
				</ul>
			</div>
		</div>
	</div>
	<div class="panel panel-default">
		...
		<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
			<div class="menu-body">
				<ul class="accordian-menu-products">
					<li><a href="../batteries/DC1150-2.html?cat=batteries&amp;voltage=2"> 2 Volt</a></li>
	...
	<div class="panel panel-default">
		...
		<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
			<div class="menu-body">
				<ul class="accordian-menu-products">
					<li><a href="../../application/aerial-work-platforms-batteries.php#view-models"> Aerial Work Platforms</a></li>
					<li><a href="../../application/commercial-trucking-batteries.php#view-models"> Commercial Trucking</a></li>
					<li><a href="../../application/floor-care-batteries.php#view-models"> Floor Cleaning Equipment</a></li>
					<li><a href="../../application/golf-batteries.php#view-models"> Golf / Electric Vehicle</a></li>
					<li><a href="../../application/marine-batteries.php#view-models"> Marine</a></li>
					<li><a href="../../application/material-handling-batteries.php#view-models"> Material Handling</a></li>
					<li><a href="../../application/oil-gas-batteries.php#view-models"> Oil &amp; Gas</a></li>
					<li><a href="../../application/rv-batteries.php#view-models"> Recreational Vehicles</a></li>
					<li><a href="../../application/solar-batteries.php#view-models"> Solar / Renewable Energy</a></li>
					<li><a href="../../application/ups-batteries.php#view-models"> UPS</a></li>
				</ul>
			</div>
		</div>
	</div>
	<div class="panel panel-default">
		...
		<div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
			<div class="menu-body">
				<ul class="accordian-menu-products">
					<li><a href="../../series/chargers/delta-q-ic650-battery-chargers.php#view-models"> Delta-Q IC650</a></li>
					<li><a href="../../series/chargers/delta-q-quiq-battery-chargers.php#view-models"> Delta-Q QuiQ</a></li>
				</ul>
			</div>
		</div>
	</div>
