<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
		...
		<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
			<div class="menu-body">
				<ul class="accordian-menu-products">
					<li><a href="../batteries/dc-series.php#view-models"> DC Series</a></li>
					<li><a href="../batteries/full-force.php#view-models"> Full Force</a></li>
					<li><a href="../batteries/hc-series.php#view-models"> HC Series</a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="panel panel-default">
		...
		<div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
			<div class="menu-body">
				<ul class="accordian-menu-products">
					<li><a href="delta-q-ic650-battery-chargers.php#view-models"> Delta-Q IC650</a></li>
					<li><a href="delta-q-quiq-battery-chargers.php#view-models"> Delta-Q QuiQ</a></li>
				</ul>
			</div>
		</div>
	</div>
