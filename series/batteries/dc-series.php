...
<div class="container-site">
	...
	<div class="container-fluid container-splash">
		<div class="splash-main">
			<img class="img-responsive splash" src="../../graphics/series/dc-series.png" alt="1 Battery Deep-Cycle AGM Batteries" title="1 Battery Deep-Cycle AGM Batteries" border="0" width="1080" height="475">
		</div>
	</div>
		...
		<div role="tabpanel">
			...
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane fade in active" id="overview">
					<p><?php echo $row_batteries['DC_Series']; ?></p>
				</div>
								...
								<?php do { ?>
									<tr>
										<td style="vertical-align: middle;">
											<a href="../../product/batteries/de-series.php?BID=<?php echo $row_DC_Series['BID']; ?>">
											<img class="responsive spec-table-img" src="../../graphics\product\<?php echo $row_DC_Series['Image']; ?>"></a>
										</td>
										<td style="vertical-align: middle;"><a href="../../product/batteries/dc-series.php?BID=<?php echo $row_DC_Series['BID']; ?>"><?php echo $row_DC_Series['Name']; ?></a></td>
										<td style="vertical-align: middle;"><?php echo $row_DC_Series['IRefer']; ?></td>
										<td style="vertical-align: middle;"><?php echo $row_DC_Series['Volt']; ?>V</td>
										<td style="vertical-align: middle;">
											<ul id="reserve-capacity">
												<li><?php echo $row_DC_Series['Cap25Min']; ?> @ 25 Amps</li>
												<li><?php echo $row_DC_Series['Cap75Min']; ?> @ 75 Amps</li>
											</ul>
										</td>
										<td style="vertical-align: middle;">
											<ul id="rate-capacity">
												<li><?php echo $row_DC_Series['Cap5HR']; ?> @ 5 HR</li>
												<li><?php echo $row_DC_Series['Cap20HR']; ?> @ 20 HR</li>
											</ul>
										</td>
										<td style="vertical-align: middle;"><?php echo $row_DC_Series['Cranking']; ?></td>
									</tr>
