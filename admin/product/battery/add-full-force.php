...
<?php
	...
	if(isset($_POST['AddNew'])){
		...
		// Default
		$Group = 'FF';
		$dc = $connection->query("INSERT INTO full_force (BID, Name, IRefer, Volt, Cap25Min, Cap75Min, Cap5HR, Cap20HR, Cranking)Values('{$BID}', '{$BID}', '{$IRefer}', '{$Volt}', '{$Cap25Min}', '{$Cap75Min}', '{$Cap5HR}', '{$Cap20HR}', '{$Cranking}')");
		...
		$distab = $connection->query("INSERT INTO bdistab (BID, 1Time, 1Amps, 1Rate, 2Time, 2Amps, 2Rate, 3Time, 3Amps, 3Rate, 4Time, 4Amps, 4Rate, 5Time, 5Amps, 5Rate, 6Time, 6Amps, 6Rate, 7Time, 7Amps, 7Rate)Values('{$BID}', '{$Time1}', '{$Amps1}', '{$Rate1}', '{$Time2}', '{$Amps2}', '{$Rate2}', '{$Time3}', '{$Amps3}', '{$Rate3}', '{$Time4}', '{$Amps4}', '{$Rate4}', '{$Time5}', '{$Amps5}', '{$Rate5}', '{$Time6}', '{$Amps6}', '{$Rate6}', '{$Time7}', '{$Amps7}', '{$Rate7}')");
...
<title>Add New Full Force Battery | 1Battery | LockersITSolution</title>
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active">Add New Full Force Battery</li>
		</ol>
	</div><!--/.row-->
	
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Add New<a href="../../product/battery/full-force.php" class="btn btn-primary pull-right">Back to Full Force</a></h1>
		</div>
	</div><!--/.row-->
				...
				<div class="panel-body">
					<form role="form" method="post">
						...
						<div class="col-md-4">
							...
							<div class="form-group">
								<label>Title*</label>
								<input name="Title" id="Title" required type="text" class="form-control" placeholder="Dual Purpose AGM Battery" />
							</div>
							<div class="form-group">
