...
<?php
	...
	if(isset($_POST['AddNew'])){
		...
		// Default
		$Group = 'DC';
		$dc = $connection->query("INSERT INTO dc_series (BID, Name, IRefer, Volt, Cap25Min, Cap75Min, Cap5HR, Cap20HR, Cranking)Values('{$BID}', '{$BID}', '{$IRefer}', '{$Volt}', '{$Cap25Min}', '{$Cap75Min}', '{$Cap5HR}', '{$Cap20HR}', '{$Cranking}')");
...
<title>Add New DC Series Battery | 1Battery | LockersITSolution</title>
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active">Add New DC Series Battery</li>
		</ol>
	</div><!--/.row-->
	
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Add New<a href="../../product/battery/dc-series.php" class="btn btn-primary pull-right">Back to DC Series</a></h1>
		</div>
	</div><!--/.row-->
					...
					<form role="form" method="post">
						...
						<div class="col-md-4">
							...
							<div class="form-group">
								...
								<input name="BID" id="BID" required type="text" class="form-control" placeholder="Battery Model 'DCxxxx-xx' etc" />
							</div>						
							<div class="form-group">
								<label>Title*</label>
								<input name="Title" id="Title" required type="text" class="form-control" placeholder="Deep-Cycle AGM Battery" />
							</div>
							<div class="form-group">
