...
$query_Distributor = "SELECT * FROM distributor where Region='Canada'";
...
<!-- MAX: 55 characters -->
<title>Distributors of Fullriver Batteries</title>
</head>
...
<div class="container container-content">
	<div class="col-md-9 col-small-7">
		<h1 class="main-header">Canada Distributors</h1>
		<!-- STATE ITEM-->
			...
			<tbody>
				...
				<tr id="results-dist">
					...
					<td class="text-center" style="vertical-align: middle;">
						<a href="<?php echo $row_Distributor['Web']; ?>" target="_blank" title="<?php echo $row_Distributor['Name']; ?>">
	...
	<div class="col-md-3 col-small-5"> 
		<h5 class="main-header">Filter by Province</h5>
		<?php include'sidebar-canada.php'; ?>
	</div>
